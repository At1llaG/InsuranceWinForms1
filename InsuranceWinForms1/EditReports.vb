...
Public Class EditReports
    ...
    '        Dim query As String = "INSERT INTO CrashReports (VehicleID1, VehicleID2, DriverID1, DriverID2, ReportDate, Location, Description, Testimonial1, Testimonial2) " &
    '                              "VALUES (:vehicleID1, :vehicleID2, :driverID1, :driverID2, :reportDate, :location, :description, :testimonial1, :testimonial2)"
